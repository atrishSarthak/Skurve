    ...
    return (
        <section className="flex min-h-screen bg-black px-4 py-16 md:py-32">
            <form
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                name="pwd"
                                id="pwd"
                                className="h-10 input sz-md variant-mixed"
                            />
                        </div>

                        <Button className="h-10 w-full">Continue</Button>
                    </div>
                </div>
                ...
                <div className="mb-2 grid grid-cols-2 gap-3 p-4">
                        <Button
                            className="h-10"
                            type="button"
                            variant="outline">
